...
namespace recipebook
{
    ...
    public:
        ...
        bool hasSpecialProvenance() const { return m_bProvenanceEverywhere; }
    ...
    private:
        Ingredient(QString strName, const Category& rCategory, Unit defaultUnit, const SortOrder* pProvenance = nullptr );
